            ...
            <section id="login" class="p-4 flex flex-col justify-center min-h-screen max-w-md mx-auto">
                <div class="p-6 bg-sky-100 rounded">
                    <div class="flex items-center justify-center font-black m-3 mb-12">
                        <h1 class="tracking-wide text-3xl text-gray-900">Edit Product <p class='text-center text-red-600'>{{ $product->name }}</p> </h1>
                    </div>
               ...
               focus:invalid:border-red-500 focus:invalid:ring-red-500"
                            type="text" name="name" id='name' value='{{$product->name}}' placeholder="product name..">
                        @error('description')
                        <p class='text-red-700'>{{ $message }}</p>
                        @enderror
               ...
               focus:ring-sky-500
               focus:invalid:border-red-500 focus:invalid:ring-red-500"
                            type='number' name="price" value='{{ round($product->price) }}' id='price' placeholder="$150">
               ...
               focus:ring-sky-500
               focus:invalid:border-red-500 focus:invalid:ring-red-500"
                            type='number' name="threepiecesprice" value='{{ round($product->threepiecesprice) }}' id="threpiecesprice" placeholder="$300">
               ...
               focus:ring-sky-500
               focus:invalid:border-red-500 focus:invalid:ring-red-500"
                            type='number' name="fivepiecesprice" id="fivepiecesprice" value='{{ round($product->fivepiecesprice) }}' placeholder="$600">
                        <div class="flex items-center mb-4">
                            <input type="checkbox" name='instock' id='instock' 
                                {{ $product->instock == 1 ? 'checked' : '' }}
                        ...
                        <input
                            class="mb-1 mt-5 block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                            name='image' id='image' type="file">
                            <img 
                            style="width: 100px; height: 100px;"
                            class='mb-10' src='{{ asset('/storage/images/'. $product->product_pics) }}'>
                        <button
